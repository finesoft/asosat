...
import org.asosat.domain.unitofwork.TransactionUnitOfWorks;
import org.asosat.domain.unitofwork.TransactionUnitOfWorksManager;
import org.asosat.domain.unitofwork.UnitOfWorks;
import org.asosat.domain.unitofwork.UnitOfWorksManager;
...
public class DefaultAggregateListener {
  ...
  void handlePostLoad(AbstractAggregate o) {
    o.initLifecycle(Lifecycle.ENABED);
  ...
  void handlePostRemove(AbstractAggregate o) {
    o.initLifecycle(Lifecycle.DESTED);
    this.registerToUnitOfWork(o);
    o.assistant().clearMessages();
  }
