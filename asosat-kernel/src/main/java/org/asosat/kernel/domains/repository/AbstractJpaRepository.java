...
import static org.asosat.kernel.domains.repository.JpaQueryBuilder.namedQuery;
...
import org.asosat.kernel.domains.annotation.stereotype.Repositories;
import org.asosat.kernel.domains.unitofwork.TransactionUnitOfWorksManager;
...
public abstract class AbstractJpaRepository implements JpaRepository {
  ...
  @Inject
  TransactionUnitOfWorksManager unitOfWorksManager;
  ...
  public EntityManager getEntityManager() {
    return this.unitOfWorksManager.getCurrentUnitOfWorks().getEntityManager();
  }
