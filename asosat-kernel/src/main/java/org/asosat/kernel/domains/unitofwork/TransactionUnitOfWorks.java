...
import static org.asosat.kernel.domains.unitofwork.PkgMsgCds.ERR_UOW_NOT_ACT;
import static org.asosat.kernel.domains.unitofwork.PkgMsgCds.ERR_UOW_TRANS;
...
import org.asosat.kernel.domains.aggregate.AggregateIdentifier;
import org.asosat.kernel.domains.aggregate.DefaultAggregateIdentifier;
import org.asosat.kernel.domains.annotation.qualifier.MessageQueue;
import org.asosat.kernel.domains.annotation.qualifier.MessageQueue.MessageQueueLiteral;
import org.asosat.kernel.domains.saga.Saga;
...
public class TransactionUnitOfWorks extends AbstractUnitOfWorks implements Synchronization {
  ...
  protected void handleMessage() {
    this.message.stream().sorted(Message::compareOccurredTime).forEachOrdered(msg -> {
      ...
      this.sagaService.getSagaManagers(queue).forEach(sm -> {
