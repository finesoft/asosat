 ...
 *
 */
public class BigIntegerConvertor implements Convertor {

  BigIntegerConverter delegate = new BigIntegerConverter(null);
   ...
   * @param delegate
   */
  public BigIntegerConvertor(BigIntegerConverter delegate) {
    this();
    if (delegate != null) {
