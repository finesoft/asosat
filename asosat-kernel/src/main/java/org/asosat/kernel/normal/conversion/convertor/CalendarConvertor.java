 ...
 *
 */
public class CalendarConvertor implements Convertor {

  CalendarConverter delegate = new CalendarConverter(null);
   ...
   * @param delegate
   */
  public CalendarConvertor(CalendarConverter delegate) {
    this();
    if (delegate != null) {
