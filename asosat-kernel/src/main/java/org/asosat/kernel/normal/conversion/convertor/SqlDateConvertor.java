 ...
 *
 */
public class SqlDateConvertor implements Convertor {

  SqlDateConverter delegate = new SqlDateConverter(null);
   ...
   * @param delegate
   */
  public SqlDateConvertor(SqlDateConverter delegate) {
    this();
    if (delegate != null) {
