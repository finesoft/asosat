 ...
 *
 */
public class SqlTimeConvertor implements Convertor {

  SqlTimeConverter delegate = new SqlTimeConverter(null);
   ...
   * @param delegate
   */
  public SqlTimeConvertor(SqlTimeConverter delegate) {
    this();
    if (delegate != null) {
