 ...
 *
 */
public class SqlTimestampConvertor implements Convertor {

  SqlTimestampConverter delegate = new SqlTimestampConverter(null);
   ...
   * @param delegate
   */
  public SqlTimestampConvertor(SqlTimestampConverter delegate) {
    this();
    if (delegate != null) {
