...
/**
 * @author bingo 下午12:10:07
 *
 */
public class NoSuchMessageException extends RuntimeException {

  private static final long serialVersionUID = -6124056330849547896L;

  public NoSuchMessageException(String key) {
    super("No message found under key '" + key + "' for locale '" + Locale.getDefault() + "'.");
  }
