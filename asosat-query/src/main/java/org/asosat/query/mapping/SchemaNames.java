...
public class SchemaNames {
  ...
  public static final String PARAM_ENTRY_ELE = "entry";
  public static final String PARAM_ENTRY_ATT_NME = "name";
  public static final String PARAM_ENTRY_ATT_TYP = "type";
  ...
  public static final String QUE_HIT_ATT_KEY = "key";
  public static final String QUE_HIT_ATT_VAL = "value";
  public static final String QUE_ATT_NAME = "name";
