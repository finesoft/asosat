...
public class DimensionInfo implements ValueObject {
	...
	public DimensionInfo(BigDecimal length, BigDecimal width, BigDecimal height, MeasureUnit unit, boolean strict) {
		super();
		if (strict) {
	...
	public String asDescription(int fixScala, String format) {
		return String.format(format,
				length == null ? "?"
						: fixScala < 0 ? length : length.setScale(fixScala, RoundingMode.HALF_UP).toPlainString(),
				width == null ? "?"
						: fixScala < 0 ? width : width.setScale(fixScala, RoundingMode.HALF_UP).toPlainString(),
				height == null ? "?"
						: fixScala < 0 ? height : height.setScale(fixScala, RoundingMode.HALF_UP).toPlainString(),
	...
	public boolean canFit(DimensionInfo other, BigDecimal lengthOffset, BigDecimal widthOffset, BigDecimal heightOffset,
