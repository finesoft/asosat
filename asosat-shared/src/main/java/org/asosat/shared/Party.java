...
public interface Party extends Nameable {
	 ...
	 * @return
	 */
	List<? extends Party> getEntrustingParties(Predicate<PartyAccountability> predicate, boolean includeHierarchy);
	 ...
	 * @return
	 */
	List<? extends Party> getResponsibleParties(Predicate<PartyAccountability> predicate, boolean includeHierarchy);
	...
	public interface PartyAccountabilityType extends Nameable {
		 ...
		 */
		PartyAccountability buildAccountability(final Party entrustingParty, final PartyRole entrustingPartyRole,
