...
import static org.asosat.unitwork.PkgMsgCds.ERR_UOW_NOT_ACT;
import static org.asosat.unitwork.PkgMsgCds.ERR_UOW_TRANS;
...
public class TransactionUnitOfWorks extends AbstractUnitOfWorks implements Synchronization {
  ...
  protected TransactionUnitOfWorks(TransactionUnitOfWorksService manager, Transaction transaction) {
    super(manager);
  ...
  @Override
  protected TransactionUnitOfWorksService getManager() {
    return (TransactionUnitOfWorksService) this.manager;
  }

  protected void handleMessage() {
    this.message.stream().sorted(Message::compare).map(this.messageService::persist)
